...
task :prep do
  ...
  schedule1 = schedule_repo.create({name: "Bob's Schedule", username: "Bob"})
  schedule2 = schedule_repo.create({name: "Joe's Schedule", username: "Joe"})
  ...
  task2 = task_repo.create({name: "Gym", description: "Picking heavy things up and putting them down", type: "Exercise", start_time: "6:00pm", end_time: "8:00pm", monday: true, tuesday: false, wednesday: true, thursday: false, friday: true, saturday: false, sunday: false, schedule: schedule2}) 
  task3 = task_repo.create({name: "Cleaning", description: "Cleaning my living space", type: "Personal", start_time: "9:00pm", end_time: "10:00pm", monday: false, tuesday: false, wednesday: true, thursday: false, friday: false, saturday: false, sunday: true, schedule: schedule2}) 
